...
var modals = function modals() {
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); // showModalByTime('.popup_engineer', 4000);
};
...
var tabs = function tabs(wrap, tab, content, classAct) {
  ...
  wrapper.addEventListener('click', function (e) {
    ...
    if (target && (target.classList.contains(tab.replace('.', '')) || target.parentNode.classList.contains(tab.replace('.', '')))) {
      console.log(target);
      tabsAll.forEach(function (item, i) {
